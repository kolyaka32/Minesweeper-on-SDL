...
static  zip_t* openarchive(const char* archiveName){
...
static  SDL_RWops* dataFromarchive(const char* name){
    // Openning need file
...
// Function of loading game icone
 unsigned loadIcone(const char* name){
    // Getting icone data
...
static void loadPicture(const char* name, enum IMG_names number){
...
static void loadMusic(const char* name, enum MUS_names number){
...
static void loadSound(const char* name, enum SND_names number){
...
unsigned loadAllImages(){
    ...
    loadPicture("img/but.png", IMG_MINE_CLOSE);
    loadPicture("img/but10.png", IMG_MINE_NORMAL);
    loadPicture("img/but12.png", IMG_MINE_GREEN);
    loadPicture("img/but11.png", IMG_MINE_RED);

    loadPicture("img/but0.png", IMG_FLAG_RIGHT);
    loadPicture("img/but1.png", IMG_FLAG_WRONG);

    loadPicture("img/num_0.png", IMG_MINE_0);
    loadPicture("img/num_1.png", IMG_MINE_1);
    loadPicture("img/num_2.png", IMG_MINE_2);
    loadPicture("img/num_3.png", IMG_MINE_3);
    loadPicture("img/num_4.png", IMG_MINE_4);
    loadPicture("img/num_5.png", IMG_MINE_5);
    loadPicture("img/num_6.png", IMG_MINE_6);
    loadPicture("img/num_7.png", IMG_MINE_7);
    loadPicture("img/num_8.png", IMG_MINE_8);
